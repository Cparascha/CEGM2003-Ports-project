...
- `merged_satellite_try2.tif` — input GeoTIFF - smaller version of merged_satellite to make computing times faster *(placeholder in this repo; see SURF drive for the full file:)*
